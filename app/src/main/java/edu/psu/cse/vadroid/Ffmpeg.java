 ...
 */
public class Ffmpeg {
    private static String OLD_BIN_FOLDER_PATH = "/data/data/edu.psu.cse.vadroid/assets/";
    public static String BIN_FOLDER_PATH = "/data/data/edu.psu.cse.vadroid/bin/";
    ...
    private static void copyFile(String oldPath, String newPath) {
        try {
            ...
            InputStream inStream = VADroid.getContext().getResources().getAssets().open(oldPath); // input
            // xml
            // in
            // assests
            // folder
